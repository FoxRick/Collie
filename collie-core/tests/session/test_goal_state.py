...
def test_trusted_goal_start_requires_both_command_markers():
    assert trusted_goal_start_requested({}) is False
    assert trusted_goal_start_requested({"goal_requested": True}) is False
    assert trusted_goal_start_requested({"original_command": "/goal"}) is False
    assert trusted_goal_start_requested({
        "goal_requested": True,
