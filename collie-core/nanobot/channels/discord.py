...
if DISCORD_AVAILABLE:
    ...
    class DiscordBotClient(discord.Client):
        ...
        def _register_app_commands(self) -> None:
            # Collie has no slash commands — natural language only. Only
            # /help stays, so Discord users can find their footing.
            @self.tree.command(name="help", description="What Collie can do")
