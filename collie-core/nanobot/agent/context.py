...
class ContextBuilder:
    ...
    # Collie bootstrap files: personality, user context, structured memory.
    # All live at the workspace root and are editable in Settings.
    ...
    def __init__(self, workspace: Path, timezone: str | None = None, disabled_skills: list[str] | None = None):
        ...
        # Enabled by the Collie runtime while nanobot's standalone prompt
        # contract remains unchanged.
        self.command_guidance = False
    ...
    def _load_bootstrap_files(self, workspace: Path | None = None) -> str:
        """Load Collie's global bootstrap plus any project-local instructions."""
        parts: list[str] = []
        root = workspace or self.workspace
        roots = [("Collie", self.workspace)]
        if root.resolve() != self.workspace.resolve():
