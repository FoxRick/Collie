...
class MCPToolWrapper(_MCPWrapperBase):
    ...
    def __init__(
        ...
        *,
        ...
        if connector_provider_id:
            ...
            self._connector_risk = classify_connector_tool(
                tool_def.name,
    ...
    def read_only(self) -> bool:
        return self._connector_risk == "read"

    def permission_request(self, params: dict[str, Any]) -> Any:
        if not self._connector_provider_id:
            return None
            ...
            try:
                ...
                try:
                    ...
                    if rendered.lstrip().startswith("{"):
                        # Structured artifact payloads are already compact and
                        # data-only; keep them parseable.
                        return rendered
