...
class SubagentManager:
        ...
        try:
            ...
            try:
                result = await self.runner.run(AgentRunSpec(
                    ...
                    execution_mode=str(origin.get("execution_mode") or "execute"),
                    run_id=origin.get("run_id"),
                    plan_id=origin.get("plan_id"),
                    plan_version=origin.get("plan_version"),
    ...
    async def cancel_all(self) -> int:
        """Cancel and drain every running subagent, including sessionless work."""
    ...
    def get_running_sessions(self) -> list[str]:
        """Return session keys that currently have background helpers."""
        return [
            session_key
    ...
    def get_running_statuses_by_session(self, session_key: str) -> list[dict[str, Any]]:
        """Return UI-safe details for the subagents currently helping a session."""
